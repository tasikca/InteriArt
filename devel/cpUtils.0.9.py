...
#
# Connor's code to calculate a path element
# with Newtwon's method
#
...
#
# Connor's divide mu interval to work with
# Newton's point selection
#
...
#
# Connor's generate path to work with Newton's
# point placement
#
def generateNewtonPath(A,b,c):
...
def plotTulip(numFacets,c,numPetalsPerLayer,numPathsPerPetal,vertScaling,\
   ...
   cp = generateNewtonPath(Astem,bstem,cstem)
   p,q = np.shape(cp)
...
#
# Try to write an STL file for a sufarce
# to print tulips
#
